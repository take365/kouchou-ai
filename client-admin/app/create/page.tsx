  ...
  const runCreateReport = async (): Promise<boolean> => {
    ...
    try {
      ...
      await createReport({
        ...
        openai_api_key: aiSettings.provider === "openai" ? aiSettings.openaiApiKey : undefined,
        openrouter_api_key: aiSettings.provider === "openrouter" ? aiSettings.openrouterApiKey : undefined,
