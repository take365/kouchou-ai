...
def request_to_chat_ai(
    ...
    if provider == "azure":
        ...
        return request_to_openai(messages, model, is_json, json_schema, api_key)
    elif provider == "local":
        ...
        return request_to_openrouter_chatcompletion(messages, model, is_json, json_schema, api_key)
    else:
